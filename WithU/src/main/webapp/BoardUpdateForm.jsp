...
<body>
	<div class="board-write-jeon">
		...
		<div class="board-write-info-jeon">
			...
			<div>
				<span>아이디</span>
				<input type="text" name="userid" size="30" value="${bean.userid }">
			</div>
			<div>
				<span>비밀번호</span>
		...
		<div class="board-write-content-jeon"><div>내용:</div> 
			<textarea rows="17" cols="100" name="content" >${bean.content }</textarea>
		</div>
		<div class="board-write-button-jeon">
			<input type="hidden" name="num" value="${bean.num}">
			<input type="hidden" name="pass" value="${bean.userpass}">
			<input type="submit" value="글수정">
			<input type="button" onclick="location.href='BoardListCon.do'" value="전체보기">
		</div>
	</form>
	</div>
</body>
